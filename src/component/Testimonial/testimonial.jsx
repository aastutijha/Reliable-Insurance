  ...
  <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <div className="md:flex md:items-end md:justify-between">
      <div className="max-w-xl">
        <h2 className="text-4xl font-bold tracking-tight text-blue-500 sm:text-5xl">
      ...
      <a
        href="#"
        className="mt-6 inline-flex shrink-0 items-center gap-2 rounded-full border border-color px-5 py-3 text-color transition hover:bg-color hover:text-white md:mt-0"
      >
    ...
    <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
      ...
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-blue-500 sm:text-3xl">Amazing plan </p>
      ...
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-blue-500 sm:text-3xl">Great Customer Service</p>
